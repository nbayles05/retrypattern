...
namespace Tests
{
    public class ExponentialBackoffWaitTests
    {
        ...
        [TestCase(2000, true, 1, 2000, Int32.MaxValue)]
        [TestCase(2000, true, 2, 4000, Int32.MaxValue)]
        [TestCase(2000, true, 3, 8000, Int32.MaxValue)]
        [TestCase(2000, true, 4, 16000, Int32.MaxValue)]
        ...
        [TestCase(2000, false, 1, 4000, Int32.MaxValue)]
        [TestCase(2000, false, 2, 8000, Int32.MaxValue)]
        [TestCase(2000, false, 3, 16000, Int32.MaxValue)]
        [TestCase(2000, false, 4, 32000, Int32.MaxValue)]
        // the max wait should override
        [TestCase(2000, false, 5, 64000, Int32.MaxValue)]
